    ...
    <main className={styles.page}>
      <div className={styles.phoneCanvas}>
        <header className={styles.header}>
          <Image src="/home/eye-icon.png" alt="Segna" width={58} height={58} priority />
          <h1 className={styles.title}>Your new wardrobe starts here</h1>
        </header>
        ...
        <Image src="/home/separator.png" alt="" width={154} height={2} className={styles.separator} />
