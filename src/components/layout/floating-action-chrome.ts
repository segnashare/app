...
export const FLOATING_ROUND_ACTION_SHELL_CLASS = cn(
  "pointer-events-auto relative flex size-[60px] shrink-0 items-center justify-center rounded-full bg-black text-white",
  "shadow-[0_10px_28px_rgba(0,0,0,0.28)] transition hover:bg-zinc-900 active:scale-[0.97]",
);
