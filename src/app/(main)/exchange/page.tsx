...
export default async function ExchangePage() {
  ...
  const [membershipStateRes, subscriptionRowRes, rolesRes, walletRes, activeCartRes, lendsRes, ongoingRes, historyRes, intakeBannersRes] =
    ...
    supabase
      ...
      .is("deleted_at", null)
      .in("status", ["draft", "draft_deleted", "available", "in_cart", "reserved", "sold", "refused", "retired"])
      .order("updated_at", { ascending: false })
      .limit(50),
    ),
    ...
    supabase
      ...
      .in("items.status", ["draft", "draft_deleted", "available", "in_cart", "reserved", "sold", "refused", "retired"])
