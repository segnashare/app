...
export default function OnboardingMotivationPage() {
  ...
  return (
    <OnboardingScreenShell
      currentStep="/onboarding/motivation"
      nextStep="/onboarding/experience"
      layoutCarreSvg={<img src="/ressources/icons/segna.svg " alt="" className={themeClassNames.onboarding.shell.svgRemplitCadre} />}
      ...
      h1Principal={
        <h1 className={cn(playfairDisplay.className, "max-w-[560px]", themeClassNames.onboarding.textes.h1PlayfairDisplayExtraBold)}>
          Pourquoi échanger avec Segna ?
        </h1>
      }
      mainLayout={<OnboardingMotivationCore formId="onboarding-motivation-form" onCanContinueChange={setCanContinue} />}
      ...
      nextArrowForm="onboarding-motivation-form"
      nextArrowEnabled={canContinue}
      nextArrowAriaLabel="Valider tes motivations"
    />
  );
}
