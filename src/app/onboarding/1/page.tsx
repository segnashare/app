...
export default function OnboardingCheckpointOnePage() {
  ...
  return (
    <AppViewport className="bg-[#f9f9f8] px-0 py-0 md:w-[466px] md:!max-w-[466px] md:py-0">
      <OnboardingStepTracker currentStep="/onboarding/1" />
      <section className="px-6 pt-[clamp(2.75rem,10vh,7rem)] md:px-6 md:pt-30">
      ...
      >
        <p className={`${montserrat.className} text-[23px] font-bold leading-[1.15] text-white`}>Ajouter des informations</p>
      </button>
