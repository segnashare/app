-- Supprime cart_id sur wallet_transactions (non utilisé ; crédits sans panier).
-- Met à jour les fonctions qui inséraient encore cette colonne.
...
alter table public.wallet_transactions
  drop constraint if exists wallet_transactions_cart_id_fkey;
