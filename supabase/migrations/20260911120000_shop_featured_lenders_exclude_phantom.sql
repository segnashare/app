-- Boutique « Nos supers prêteuses » : exclure les comptes en mode Phantom (aligné catalogue shop / feed).
...
comment on function public.get_shop_featured_lenders(integer) is
  'Boutique : prêteuses (pièces au catalogue), hors soi, hors corporate, hors mode Phantom, hors rôle organization, hors email @segnashare.com (non null).';
