-- Boutique /shop : facettes filtres en un seul aller-retour (remplace 5 SELECT séquentiels / parallèles).
...
comment on function public.get_shop_boutique_filter_facets() is
  'Boutique : facettes filtres (catégories, tailles, marques, couleurs, matériaux) en un seul appel.';
