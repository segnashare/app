-- `bootstrap_user_after_signup` (parrainage) insérait `/onboarding/welcome`, absent de la contrainte
-- `onboarding_sessions_current_step_check` tant que seule la migration « slim » (20260418) est en place.
-- Alignement sur le bootstrap standard : `/onboarding/1` (déjà utilisé après `upsert_onboarding_progress` côté app).
