-- Plus de blocage « capacité wallet » à l’entrée checkout : toutes les lignes passent en réservées.
-- Le manque de crédits d’emprunt / d’échange se règle au paiement (Stripe) lors de la confirmation.
