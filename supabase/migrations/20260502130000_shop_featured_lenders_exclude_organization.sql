-- Exclure les comptes « organization » (user_roles) des supers prêteuses boutique.
...
comment on function public.get_shop_featured_lenders(integer) is
  'Boutique : prêteuses (pièces au catalogue), hors soi, hors corporate, hors rôle organization.';
