-- Compte technique stock Segna : pas de découverte sociale (feed) ni profil “membre”.
-- La valeur d’enum corporate_inventory est ajoutée dans 20260402155900 (transaction séparée).
